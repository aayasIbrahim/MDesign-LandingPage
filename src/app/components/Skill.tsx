    ...
    <section className="mt-[188px]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/2 flex flex-col">
          ...
          <h1 className="font-inter font-semibold text-[40px] leading-[54px] mt-[10px]">
            Why Hire Me For Your Next{" "}
            <span className="text-green-400">Project?</span>
          </h1>
          <p className="font-inter font-normal text-base leading-[150%] mt-[24px]">
          ...
          <div className="w-[138px] h-[56px] bg-green-400 rounded-[12px] mt-[40px] flex justify-center items-center">
            <a
              href=""
              className="font-inter font-medium text-base leading-[150%] text-white"
            >
              Hire Me
            </a>
          </div>
        ...
        <div className="lg:w-1/2 flex flex-wrap gap-6">
          {SKILLS.map((skill) => (
            <div
              key={skill.id}
              className="shadow-lg p-6 flex-1 min-w-[200px] rounded-lg"
            >
              <Image
                src={skill.icon}
                alt={skill.title}
                ...
                height={28}
              />
              <h2 className="font-poppins font-semibold text-[20px] leading-[20px] mt-[16px]">
                {skill.title}
              </h2>
              <p className="font-inter font-normal text-[14px] leading-[150%] mt-[12px]">
                {skill.description}
              </p>
            </div>
          ))}
