...
const DOTS = [
  ...
  ['bg-green-500', 'w-5 h-5', 'top-[50px] left-32'],
  ['bg-blue-500', 'w-5 h-5', 'top-23 left-50'],
  ['bg-yellow-500', 'w-4 h-4', 'top-20 left-80'],
  ['bg-purple-500', 'w-2 h-2', 'top-22 left-48'],
  ['bg-pink-400', 'w-3 h-3', 'top-24 left-64'],
  ['bg-indigo-500', 'w-8 h-8', 'top-32 left-20'],
  ['bg-teal-400', 'w-2 h-2', 'top-0 right-0'],
  ...
  ['bg-rose-400', 'w-2 h-2', 'bottom-8 left-40'],
  ['bg-emerald-400', 'w-3 h-3', 'bottom-16 right-10'],
  ['bg-sky-400', 'w-5 h-5', 'bottom-0 right-32'],
  // Extra Dots for more confetti effect
  ['bg-purple-300', 'w-2 h-2', 'top-12 left-24'],
  ['bg-pink-500', 'w-3 h-3', 'top-9 right-12'],
  ['bg-green-300', 'w-6 h-6', 'bottom-12 left-20'],
  ['bg-yellow-300', 'w-3 h-3', 'bottom-6 right-24'],
];
