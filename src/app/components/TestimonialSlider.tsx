...
//         Our Customer Say{" "}
//         <span className="text-green-500">Something About Us</span>
//       </h2>
//     </div>
//   </div>

//   {/* Swiper Slider with relative container */}
...
//   {/* ✅ Navigation Buttons (desktop only, overlay top of slider) */}
//   <div className="hidden md:flex absolute top-[-50px] transform -translate-y-1/2 right-4 space-x-2 z-10">
//     <button
//       ref={prevRef}
    ...
    <section className="max-w-7xl mx-auto px-4 py-20 relative overflow-hidden my-[188px]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16">
        <div className="mb-4 md:mb-0">
          ...
          <h2 className="font-inter font-semibold text-[40px] leading-[54px] tracking-[0px]   ">
            Our Customer Say{" "}
            <br/>
            <span className="text-green-500 pe-[10px] br">Something About Us</span>
          </h2>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="hidden md:flex absolute top-[-50px] right-4 space-x-2 z-10">
          <button
            ref={prevRef}
            className="w-10 h-10 bg-green-400 text-white flex items-center justify-center rounded-md shadow-lg hover:bg-green-500 transition"
          >
        ...
        {navigationReady && (
          ...
          >
            {reviews.map((review) => (
              <SwiperSlide key={review.id}>
                <div className="bg-white p-6 rounded-xl border-transparent transition duration-300 h-full flex flex-col justify-between">
                  <StarRating count={review.rating} />
                  <p className="text-gray-600 text-base mb-6">{review.text}</p>
                  <div className="flex items-center mt-auto">
                    <Image
